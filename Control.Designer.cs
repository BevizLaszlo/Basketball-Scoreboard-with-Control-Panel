...
namespace KosarVezerlo
{
    partial class Control
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.awayPicCP.TabStop = false;
            // 
            // mainPanel
            // 
            this.mainPanel.Anchor = System.Windows.Forms.AnchorStyles.None;
            this.mainPanel.Controls.Add(this.awayPicCP);
            this.mainPanel.Controls.Add(this.homePicCP);
            this.mainPanel.Controls.Add(this.awayRadio);
            this.mainPanel.Controls.Add(this.homeRadio);
            this.mainPanel.Controls.Add(this.away3btn);
            ...
            this.mainPanel.Controls.Add(this.away1btn);
            this.mainPanel.Controls.Add(this.away0btn);
            this.mainPanel.Controls.Add(this.awayTO);
            this.mainPanel.Controls.Add(this.homeTO);
            this.mainPanel.Controls.Add(this.home0btn);
            this.mainPanel.Controls.Add(this.homeM1btn);
            this.mainPanel.Controls.Add(this.home1btn);
            this.mainPanel.Controls.Add(this.label3);
            this.mainPanel.Controls.Add(this.label2);
            this.mainPanel.Controls.Add(this.label1);
            this.mainPanel.Location = new System.Drawing.Point(17, 11);
            ...
            ((System.ComponentModel.ISupportInitialize)(this.homePicCP)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(this.awayPicCP)).EndInit();
